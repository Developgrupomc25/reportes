...
class PrintRecepcion(report_sxw.rml_parse):
    
    def __init__(self, cr, uid, name, context):
        super(PrintRecepcion, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw(
    'report.print.recepcion.webkit', 
    'mrp.servicemc', 
    'addons/mrp_servicemc/report/print_recepcion.mako', 
    parser=PrintRecepcion,
)
